...
import com.example.oops.HomeActivity;
...
public class WholesalerAddCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wholesaler_add_category);
        AddProduct=findViewById(R.id.wholesaler_add_product);
        Productname=findViewById(R.id.wholesaler_product_name);
        Productprice=findViewById(R.id.wholesaler_product_price);
        Productdesc=findViewById(R.id.wholesaler_product_desc);
        ProductImage=findViewById(R.id.wholesaler_product_image);
        loadingbar=new ProgressDialog(this);

        Categoryname=getIntent().getExtras().get("category").toString();
        productImagesRef= FirebaseStorage.getInstance().getReference().child("ProductImages");
        productRef= FirebaseDatabase.getInstance().getReference().child("Wholesaler Products");
    ...
    private void StoreProductInformation() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(WholesalerAddCategory.this, "122 "+message, Toast.LENGTH_SHORT).show();
                loadingbar.dismiss();
            }
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(WholesalerAddCategory.this, "image uploaded successfully", Toast.LENGTH_SHORT).show();
                Task<Uri> uriTask=uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            Toast.makeText(WholesalerAddCategory.this, "product image url saved to database successfully", Toast.LENGTH_SHORT).show();
                            SaveProductInfoToDB();
                        }
                ...
                addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            loadingbar.dismiss();
                            Toast.makeText(WholesalerAddCategory.this, "product added successfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadingbar.dismiss();
                            String message=task.getException().toString();
                            Toast.makeText(WholesalerAddCategory.this,"140 "+ message, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
